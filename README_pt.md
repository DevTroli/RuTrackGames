...
| `f linux|windows|mac` | Filtrar por plataforma |
| `n` / `p` | Próxima / anterior |
| `!info <n>` | Detalhes do jogo |
...
- ⚡ Assíncrono: 24 conexões paralelas (aiohttp)
- 📦 Cache XDG em `~/.cache/rl/`
- 🔒 SSL/TLS + Proteção SSRF
- 🎨 Interface TUI colorida com Rich
- 🔍 Busca inteligente: correspondência substring/AND

---

> Não afiliado ao RuTracker.org. Sujeito aos [Termos de Serviço](https://rutracker.org/forum/rules.php).
